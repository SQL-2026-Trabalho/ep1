-- B+ tree indexes for nao_chave-primarias_com_selecoes_compostas (MySQL)
CREATE INDEX idx_users_location_rep_btree ON Users (Location(255), Reputation);
...
CREATE INDEX idx_badges_name_date_btree ON Badges (Name(255), Date);
...
CREATE INDEX idx_posttypes_type_btree ON PostTypes (Type(255));
CREATE INDEX idx_votetypes_name_btree ON VoteTypes (Name(255));
CREATE INDEX idx_linktypes_type_btree ON LinkTypes (Type(255));
