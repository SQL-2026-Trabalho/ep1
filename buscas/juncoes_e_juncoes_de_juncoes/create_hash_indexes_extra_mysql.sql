...
CREATE INDEX idx_votetypes_name_hash_extra2 ON VoteTypes (Name(255)) USING HASH;
CREATE INDEX idx_linktypes_type_hash_extra2 ON LinkTypes (Type(255)) USING HASH;
